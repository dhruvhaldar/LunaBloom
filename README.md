...
![GitHub Release](https://img.shields.io/github/v/release/dhruvhaldar/LunaBloom/releases)
...
2. Graphics - icons, splash screen, cover image for pages

3. Optimize for Play Store Launch

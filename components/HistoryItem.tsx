...
const HistoryItem = React.memo(function HistoryItem({ item, onDelete, textColor, deleteIconColor }: HistoryItemProps) {
  ...
  const accessibilityEntryLabel = useMemo(() => {
    return `Entry for ${logDate}. Last Period: ${lastPeriodDate}. Cycle Length: ${item.cycleLength} days. Symptoms: ${symptomsString}. Flow: ${item.selectedFlow || 'Not logged'}. Notes: ${item.notes}`;
    ...
    <View style={styles.entry}>
      <View style={styles.entryContent}>
        <View
          ...
          accessible={true}
          accessibilityLabel={accessibilityEntryLabel}
        >
